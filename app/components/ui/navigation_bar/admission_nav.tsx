          ...
          >
            ...
            <li className="relative">
              ...
              {openMenu === "Student_Information" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    { label: "View Master Data", href: "/mis_admission/adm_master_data_fetch" },
                    { label: "Import From Excel", href: "/mis_admission/adm_import_excel" },
                    {
            ...
            <li className="relative">
              ...
              {openMenu === "Admission_Statistics" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    { label: "Branch wise Admissions", href: "/mis_admission/adm_statistics_branch" },
                    { label: "Category wise Admissions", href: "/mis_admission/adm_statistics_category" },
                    { label: "Quota wise Statistics", href: "/mis_admission/adm_statistics_quota" },
                    { label: "Rank Statistics", href: "/mis_admission/adm_rank_statistics" },
                  ].map((item) => (
                    <li
                      key={item.label}
            ...
            <li className="relative">
              ...
              {openMenu === "VTUUsnoUpdate" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    { label: "Update COB Branch/USNO", href: "/mis_admission/adm_cob_usno_brcode" },
                    { label: "Update New USNO", href: "/mis_admission/adm_vtu_usno_update" },
                  ].map((item) => (
                    <li
                      key={item.label}
                      className="hover:bg-gray-200 px-4 py-2 whitespace-nowrap"
            ...
            <li className="relative">
              ...
              {openMenu === "VerticalProgression" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    { label: "Mark Dropout", href: "/mis_admission/adm_dropout_mark" },
                    { label: "Eligibility Update", href: "/mis_admission/adm_eligibility_update" },
                  ].map((item) => (
                    <li
                      key={item.label}
                      className="hover:bg-gray-200 px-4 py-2 whitespace-nowrap"
            ...
            <li className="relative">
              ...
              {openMenu === "Admission_Certificates" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    { label: "Bonafied Certificate", href: "/mis_admission/adm_certificate_bonafied" },
                    { label: "Study Certificate", href: "/mis_admission/adm_study_certificate" },
                    { label: "Transfer Certificate", href: "/mis_admission/adm_certificate_tc" },
                  ].map((item) => (
                    <li
                      key={item.label}
                      className="hover:bg-gray-200 px-4 py-2 whitespace-nowrap"
              ...
              {openMenu === "Contact" && (
                <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                  {[
                    ...
                    { label: "Message", href: "/mis_admission/adm_sendMessage" },
                  ].map((item) => (
                    <li
                      key={item.label}
                      className="hover:bg-gray-200 px-4 py-2 whitespace-nowrap"
            ...
            {user?.role === "adm_admin" && ( // Conditionally render the menu for Admin role
              <li className="relative">
                ...
                {openMenu === "Settings" && (
                  <ul className="absolute left-0 bg-white text-black mt-2 shadow-lg rounded z-50">
                    {[
                      { label: "User Management", href: "/mis_admission/adm_user_mgmt" },
                      { label: "Student Intake Management", href: "/mis_admission/adm_intake_fetch" },
                      { label: "Branch Management", href: "/mis_admission/adm_branch" },
                      { label: "Save Old USNO", href: "/mis_admission/adm_save_oldusno" },
                      { label: "Mark Change of Branch", href: "/mis_admission/adm_cob_mark" },
                    ].map((item) => (
                      <li
                        key={item.label}
                        className="hover:bg-gray-200 px-4 py-2 whitespace-nowrap"
